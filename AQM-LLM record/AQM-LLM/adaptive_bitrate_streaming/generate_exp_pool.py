#这段代码主要用于使用不同的算法模型（如 Pensieve、MPC、BBA）在视频流环境中收集经验数据，并将这些数据保存到一个经验池中。以下是详细的解释：
import argparse
import os
import pickle
import itertools
...
# ========================= MPC Special (Start) ===========================
# =========================================================================
#这些函数实现了MPC算法，通过预测未来的带宽来选择最佳的比特率。
...
#这个函数运行整个实验流程，加载轨迹数据，初始化环境，选择模型，收集经验，并将结果保存到文件中。
def run(args):
